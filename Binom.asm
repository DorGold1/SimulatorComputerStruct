	...
	add $sp, $sp, $imm2, $zero, 0, -2     	# adjust stack for 3 items
	jal $ra $zero, $zero, $imm2, 0, fib		#calc $v0 = bin(n,k)


bin:
	add $sp, $sp, $imm2, $zero, 0, -3     	# adjust stack for 3 items
	sw $zero, $sp, $imm2, $a1, 0, 2			# save $a0
	sw $zero, $sp, $imm2, $a0, 0, 1			# save return address
	sw $zero, $sp, $imm2, $r0, 0, 0			# save argument
	beq

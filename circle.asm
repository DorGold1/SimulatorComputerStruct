	...
	add $s0, $imm1, $zero, $zero, 127, 0    # set $s0 = center of circle
...
check_colour:
	...
	add $t0, $t0, $t1, $zero, 0, 0 # getting ready for pitagoras
	ble $zero, $t0, $s1, $imm1, colour_pixel, 0 # pitagoras! if less then colour the pixel!
	beq $zero, $zero, $zero, $imm1, iterate, 0 # continue to iterate
